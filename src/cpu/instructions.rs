...
const INSTRUCTION_SET: [Instruction; 256] = [
    ...
    instruction!("TODO", 160, 0, 0),
    instruction!("LD", 161, 2, 6, InstructionType::LD),
    instruction!("TODO", 162, 0, 0),
    instruction!("TODO", 163, 0, 0),
    instruction!("TODO", 164, 0, 0),
    instruction!("LD", 165, 2, 3, InstructionType::LD),
    instruction!("TODO", 166, 0, 0),
    ...
    instruction!("LD", 173, 3, 4, InstructionType::LD),
    instruction!("TODO", 174, 0, 0),
    instruction!("TODO", 175, 0, 0),
    instruction!("TODO", 176, 0, 0),
    instruction!("LD", 177, 2, 5 /*+1 if page boundary crossed*/, InstructionType::LD),
    instruction!("TODO", 178, 0, 0),
    instruction!("TODO", 179, 0, 0),
    instruction!("TODO", 180, 0, 0),
    instruction!("LD", 181, 2, 4, InstructionType::LD),
    instruction!("TODO", 182, 0, 0),
    instruction!("TODO", 183, 0, 0),
    instruction!("TODO", 184, 0, 0),
    instruction!("LD", 185, 3, 4 /* +1 if page boundary crosses */, InstructionType::LD),
    instruction!("TODO", 186, 0, 0),
    instruction!("TODO", 187, 0, 0),
    instruction!("TODO", 188, 0, 0),
    instruction!("LD", 189, 3, 4 /* +1 if page boundary crossed */, InstructionType::LD),
    instruction!("TODO", 190, 0, 0),
